...
1. The [Gatling core and HTTP imports]({{< ref "/tutorials/javascript/scripting-intro-js/#set-up-the-file" >}}) are used for all 
   functionalities not specific to Postman.
2. As for all [JavaScript tests]({{< ref "/tutorials/javascript/scripting-intro-js/#define-the-simulation-function" >}}), define a
   simulation function.
...
5. Don't forget to [set up an injection profile]({{< ref "/tutorials/javascript/scripting-intro-js/#define-the-injection-profile" >}}).
