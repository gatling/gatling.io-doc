...
1. The [Gatling core and HTTP imports]({{< ref "/tutorials/test-as-code/javascript/running-your-first-simulation/#set-up-the-file" >}}) are used for all 
   functionalities not specific to Postman.
2. As for all [JavaScript tests]({{< ref "/tutorials/test-as-code/javascript/running-your-first-simulation/#define-the-simulation-function" >}}), define a
   simulation function.
...
5. Don't forget to [set up an injection profile]({{< ref "/tutorials/test-as-code/javascript/running-your-first-simulation/#define-the-injection-profile" >}}).
