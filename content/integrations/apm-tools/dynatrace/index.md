...
1. See the [official Dynatrace API key documentation](https://docs.dynatrace.com/docs/platform/access-control/access-tokens) for creating an API key in your Dynatrace account. Ensure your API key has the following permissions:
    - Ingest metrics (`metrics.ingest`)
    - Write events (`events.ingest`)
...
See the [official Dynatrace Events documentation](https://docs.dynatrace.com/docs/platform-modules/infrastructure-monitoring/events/custom-events) for managing and displaying events.
