...
seotitle: Configure Azure locations in Gatling Enterprise Edition
...
aliases:
  - /reference/install/cloud/private-locations/azure/configuration/
---
...
- [Java runtime environment](https://openjdk.org/install/): OpenJDK 64bits LTS versions: 11, 17 or 21 (see [Gatling prerequisites]({{< ref "/tutorials/anything-left-over/oss#java-version" >}}))
