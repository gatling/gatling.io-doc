...
seotitle: Configure dedicated locations in Gatling Enterprise Edition
...
- [Java runtime environment](https://openjdk.org/install/):
  - For Gatling Java and Scala support: OpenJDK 64bits LTS versions: 11, 17 or 21 (see [Gatling prerequisites]({{< ref "/tutorials/anything-left-over/oss#java-version" >}}))
