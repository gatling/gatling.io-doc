...
import { WsFrameCheckText, http, isWsInboundMessageText, ws } from "@gatling.io/http";
...
const wsCheck: WsFrameCheckText = null as any;
const wsCheck1 = wsCheck;
const wsCheck2 = wsCheck;
