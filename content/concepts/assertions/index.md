...
{{< alert tip >}}
Gatling Enterprise includes ramp up and ramp down [time window options]({{< ref "/reference/run-tests/simulations/#step-4-time-window" >}}), which allows you to exclude warmup times from the assertions calculation. 
{{< /alert >}}
