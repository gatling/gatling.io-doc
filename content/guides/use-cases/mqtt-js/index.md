...
{{< alert tip >}}
New to Gatling scripting in JavaScript or TypeScript? Start with the [Create a simulation with JavaScript/TypeScript tutorial]({{< ref "/tutorials/javascript/scripting-intro-js/" >}}) before diving into protocol-specific use cases.
{{< /alert >}}
