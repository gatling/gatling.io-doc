...
{{< img src="MQTT-gatling.png" alt="Diagram of a Gatling MQTT load testing setup" >}}
...
{{< img src="MQTT-report.png" alt="Gatling Enterprise Edition report for an MQTT performance test showing connection metrics" >}}
