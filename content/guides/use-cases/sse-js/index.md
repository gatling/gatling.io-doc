...
This guide showcases the JavaScript/TypeScript SDK, but the same process applies to the Java, Kotlin, and Scala SDKs.
 ...
 If you haven't already, we recommend starting with the [Create a simulation with JavaScript/TypeScript tutorial]({{<ref "/tutorials/javascript/scripting-intro-js/" >}}) to set up your environment and understand the basics of writing simulations.
{{< /alert >}}
