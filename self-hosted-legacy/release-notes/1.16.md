...
* we recommend that you upgrade to the latest version of those plugins:
    * [maven](https://docs.gatling.io/integrations/build-tools/maven-plugin/): `io.gatling:gatling-maven-plugin:4.0.1`. Beware that this new version of the maven plugin no longer compiles Scala code itself, so you must configure the standard `scala-maven-plugin`.
    * [gradle](https://docs.gatling.io/integrations/build-tools/gradle-plugin/): `io.gatling.gradle:3.7.1`
    * [sbt](https://docs.gatling.io/integrations/build-tools/sbt-plugin/): `io.gatling:gatling-sbt:4.0.0`
